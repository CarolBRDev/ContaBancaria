...
namespace ContaBancaria
{
    class ContaBanco
    {
        ...
        public ContaBanco(string nomeTitular, int numConta, double saldo)
        {
        ...
        public ContaBanco(string nomeTitular, int numConta, double saldo, double depositoInicial) : this (nomeTitular,numConta,saldo)
        {
